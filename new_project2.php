  ...
  <body>
    <div class="container" style="padding-bottom:15px;">
      <div class="jumbotron">
        ...
        <p>Now it's time to tell a little bit about your Project so I could build a nice proposal for you.</p>
      </div>
<form action="new_project.php" name="addProject" id="projForm" method="post" role="form">
      ...
      <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="title" id="InputTitle" placeholder="Don't worry, I won't call without asking you first" required>
          </div>
          <div class="form-group">
            <label for="InputDescription">Description</label>
            <input type="text" class="form-control" name="description" id="InputDescription" placeholder="What can I help you with?" required>
          </div>
          <div class="form-group">
            <label for="InputObjective">Additional notes (optional)</label>
            <input type="text" class="form-control" name="objective" id="InputObjective" placeholder="Is there anything special I should know about?" >
          </div>
          <!-- attach file
          <div class="form-group">
